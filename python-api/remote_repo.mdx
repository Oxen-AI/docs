...
```python
def __init__(path: str, host: Optional[str] = None, revision: str = "main")
```
...
<a id="oxen.remote_repo.RemoteRepo.get_df_size"></a>
...
<a id="oxen.remote_repo.RemoteRepo.get_df_row"></a>
...
<a id="oxen.remote_repo.RemoteRepo.get_df_slice"></a>
