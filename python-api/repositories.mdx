...
Oxen has the concept of [Remote Workspaces](/getting-started/workspaces) that make it easy to add data to a remote repository without ever downloading it locally.
