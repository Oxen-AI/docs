...
<a id="oxen.workspace.Workspace.id"></a>
...
<a id="oxen.workspace.Workspace.name"></a>
...
<a id="oxen.workspace.Workspace.branch"></a>
...
<a id="oxen.workspace.Workspace.commit_id"></a>
...
<a id="oxen.workspace.Workspace.repo"></a>
