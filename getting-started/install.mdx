...
```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.7.11/oxen-ubuntu-latest-0.7.11.deb
```

```bash
sudo dpkg -i oxen-ubuntu-latest-0.7.11.deb
```

### Ubuntu 20.04

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.7.11/oxen-ubuntu-20.04-0.7.11.deb
```

```bash
sudo dpkg -i oxen-ubuntu-20.04-0.7.11.deb
```

### Windows

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.7.11/oxen.exe
```
...
```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.7.11/oxen-server-docker-0.7.11.tar
```

```bash
docker load < oxen-server-docker-0.7.11.tar
```
...
```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.7.11/oxen-server-ubuntu-latest-0.7.11.deb
```

```bash
sudo dpkg -i oxen-server-ubuntu-latest-0.7.11.deb
```

### Ubuntu 20.04

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.7.11/oxen-server-ubuntu-20.04-0.7.11.deb
```

```bash
sudo dpkg -i oxen-server-ubuntu-20.04-0.7.11.deb
```

### Windows

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.7.11/oxen-server.exe
```
