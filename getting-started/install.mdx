...
```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.12.3/oxen-ubuntu-latest-0.12.3.deb
```

```bash
sudo dpkg -i oxen-ubuntu-latest-0.12.3.deb
```

### Ubuntu 20.04

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.12.3/oxen-ubuntu-20.04-0.12.3.deb
```

```bash
sudo dpkg -i oxen-ubuntu-20.04-0.12.3.deb
```

### Windows

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.12.3/oxen.exe
```
...
```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.12.3/oxen-server-docker-0.12.3.tar
```

```bash
docker load < oxen-server-docker-0.12.3.tar
```
...
```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.12.3/oxen-server-ubuntu-latest-0.12.3.deb
```

```bash
sudo dpkg -i oxen-server-ubuntu-latest-0.12.3.deb
```

### Ubuntu 20.04

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.12.3/oxen-server-ubuntu-20.04-0.12.3.deb
```

```bash
sudo dpkg -i oxen-server-ubuntu-20.04-0.12.3.deb
```

### Windows

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.12.3/oxen-server.exe
```
