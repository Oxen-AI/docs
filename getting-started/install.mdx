...
```bash
sudo dpkg -i oxen-ubuntu-latest-0.15.7.deb
```

### Ubuntu 20.04

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.15.7/oxen-ubuntu-20.04-0.15.7.deb
```

```bash
sudo dpkg -i oxen-ubuntu-20.04-0.15.7.deb
```

### Windows

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.15.7/oxen.exe
```
...
```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.15.7/oxen-server-docker-0.15.7.tar
```

```bash
docker load < oxen-server-docker-0.15.7.tar
```
...
```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.15.7/oxen-server-ubuntu-latest-0.15.7.deb
```

```bash
sudo dpkg -i oxen-server-ubuntu-latest-0.15.7.deb
```

### Ubuntu 20.04

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.15.7/oxen-server-ubuntu-20.04-0.15.7.deb
```

```bash
sudo dpkg -i oxen-server-ubuntu-20.04-0.15.7.deb
```

### Windows

```bash
wget https://github.com/Oxen-AI/Oxen/releases/download/v0.15.7/oxen-server.exe
```
