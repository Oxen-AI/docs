...
Oxen has many more advanced features such as [computing diffs](/concepts/diffs) between tabular data as well as convenient DataFrame manipulation through the [oxen df](/concepts/data-frames) command.
