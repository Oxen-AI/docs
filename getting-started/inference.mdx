...
At the end of the day, AI is about automating workflows and making sure your model performs well given your data. With Oxen.ai, you can kick off a model to run on a [dataset](/getting-started/datasets) while you sit back and relax. This is a great way to iterate on your system prompt, [evaluate a model](/getting-started/evaluation), or to augment your dataset with new data.
