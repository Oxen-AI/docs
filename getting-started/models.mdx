...
<Warning>Currently the only model supported is `gpt-4o`. We are working on adding support for more models, including multimodal embeddings, Audio, and Vision models. If you want to use a different model, please [let us know](https://discord.gg/s3tBEn7Ptg).</Warning>
