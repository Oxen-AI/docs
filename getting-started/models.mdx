...
<Tip>We currently support several models from `gpt-4o` to `mistral 7b` but [let us know](https://discord.com/invite/s3tBEn7Ptg) if you would like to work with any additional models.</Tip>
...
<Tip>[Let us know](https://discord.com/invite/s3tBEn7Ptg) if you would like to work with any unsupported models.</Tip>
...
TODO: Add image of finished run after UI updates are shipped.
