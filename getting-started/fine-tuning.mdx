...
<img alt="Fine-Tuning Ox" className="rounded-xl" src="/images/fine_tuning/bloxy-fine-tuning.png" />
...
<img alt="Fine-Tuning Configuration" className="rounded-xl" src="/images/fine_tuning/fine-tune-deploy-model-inactive.png" />

use the activate button to load the model.

<img alt="Fine-Tuning Configuration" className="rounded-xl" src="/images/fine_tuning/fine-tune-deploy-model-active.png" />
...
If you need custom or private deployments in your own VPC or want to train a larger model on distributed infrastructure, contact us at hello@oxen.ai and we can give you a custom deployment.