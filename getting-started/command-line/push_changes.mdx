...
You can also stage changes to a remote by using a [Workspace](concepts\workspaces.mdx). This allows you to skip copying files to the local repository, making it ideal for bulk imports.
