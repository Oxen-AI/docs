...
You can also stage changes to a remote by using a [Workspace](concepts\workspaces.mdx). This allows you to skip copying files to a local repository, making it ideal for bulk imports.
