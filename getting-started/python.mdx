...
## Integrate Tools You Already Know

One of the core tenents behind Oxen is that is should be easy to grab any version of any resource at any time. This means accessing the data without pulling the entire remote repository.

You can list and paginate over files and directories with `.ls()`
...
It is also easy to download a specific file with a specific revision.
...
repo.download("annotations/train.csv", revision="COMMIT_ID_OR_BRANCH")
