...
2. [Point Local to Remote](/python-api/local_repo#set_remote)
3. [Push Changes](/python-api/local_repo#push)
...
Now that we have created the remote repository, we need to point our local repository to sync to it. This can be done with the [set_remote](/python-api/local_repo#set_remote) method.
...
Now that we have created the remote repository and pointed our local repository to it, we can [push](/python-api/local_repo#push) our changes to the remote repository.
...
Now that we have pushed our changes to the remote repository, we can [pull](/python-api/local_repo#pull) them down to another machine.
...
To create a new branch, use the [LocalRepo.checkout](/python-api/local_repo#checkout) method.
...
To list all of the branches in a repository, use the [LocalRepo.branches](/python-api/local_repo#branches) method.
