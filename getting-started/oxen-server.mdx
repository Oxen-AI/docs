...
You can either setup an `oxen-server` instance yourself, or use the hosted version on [OxenHub](https://oxen.ai). To use the hosted OxenHub solution you can sign up [here](https://oxen.ai/register). The hosted solution comes with a UI and the benefits of not having to setup infrastruture yourself.
