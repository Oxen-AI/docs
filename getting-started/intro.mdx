...
oxen commit -m "Adding 200k images and their corresponding annotations"
...
Oxen.AI's comprised of a [command line interface](https://docs.oxen.ai/getting-started/cli), as well as bindings for [Rust](https://github.com/Oxen-AI/Oxen) 🦀, [Python](https://docs.oxen.ai/getting-started/python) 🐍, and [HTTP interfaces](https://docs.oxen.ai/http-api) 🌎 to make it easy to integrate into your workflow.

## ✅ Features

Oxen is built around ergonomics, ease of use, and it is easy to learn. If you know how to use git, you know how to use Oxen.

### [Oxen Hub Features](https://docs.oxen.ai/features/web_hub)

* 🚀 [Model Inference](https://docs.oxen.ai/features/models): One click solution for your model inference.
* 📝 [Labeling Images](https://docs.oxen.ai/features/labeling_data): Edit any and all your datasets straight from our UI.
* 🔍 [Text2SQL](https://docs.oxen.ai/features/text2sql): Instant Text to SQL generation to ask your data questions.

### Oxen Open Source Features 

* 🔥 Fast: Efficient indexing and syncing of any dataset size (millions of images? no problem)
* 🌎 [Workspaces](https://docs.oxen.ai/concepts/workspaces): Interact with your data without downloading it
...
* 🤝 Team Collaborate: sync to an oxen-server
