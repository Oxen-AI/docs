...
### [Oxen Hub Features](/features/web_hub)

* 🚀 [Model Inference](/features/models): One click solution for your model inference.
* 📝 [Labeling Images](/features/labeling_data): Edit any and all your datasets straight from our UI.
...
To learn more about Oxen, you can watch our 101 video below, or work through the getting started guides in [Python](/getting-started/python) or [CLI](/getting-started/cli).
...
We hooked up the GitHub webhook for stars to an [OxenHub repository](https://www.oxen.ai/ox/FlyingOxen). Using a combination of Oxen's [python library](/getting-started/python), [remote workspaces](/concepts/workspace), and [Stable Diffusion XL](https://huggingface.co/docs/diffusers/api/pipelines/stable_diffusion/stable_diffusion_xl) we generate a unique Ox for each user, and attempt to give them wings.
