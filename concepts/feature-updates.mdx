...
- You can now download SQL query results within [workspaces](/http-api/workspaces/query_dataframe) and [UI](/features/web_hub)!
![download SQL query results](/images/download_sql_query.png)

- We cleaned up [Oxen.ai's](https://www.oxen.ai) navigation bar:)
![new-headers](/images/new_headers.png)
