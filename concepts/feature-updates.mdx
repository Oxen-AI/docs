...
- [@Mirascope](https://www.oxen.ai/Mirascope) requested named [workspaces](/examples/data/workspaces)
...
- You can now have several [workspaces](/examples/data/workspaces) with the same commit ID
...
- Enabled pushing, pulling, merging of [subtrees](/examples/data/workspaces#partial-clones)
