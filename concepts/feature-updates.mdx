...
- We now have a new [plan upgrade view](https://www.oxen.ai/settings/billing/plans) with status bars for your storage, egress, and compute usage.
...
- You can now customize build script when starting a notebook
