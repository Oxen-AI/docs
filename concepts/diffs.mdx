...
Oxen knows how to compare text files as well as [tabular data](/concepts/data-frames) between commits. Currently, you must specify the specific path to the file you want to compare the changes.
