...
The default oxen clone will clone the latest commit data on the default branch. This can be expensive depending on the size of your data repository.

## Shallow Clone / RemoteRepo
