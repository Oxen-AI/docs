...
Here, we see that [SpamOrHam](https://oxen.ai/datasets/SpamOrHam)'s dataset consists of 4,774 rows and 2 columns 
...
(INSERT DOGS/CATS DATASET HERE!). To see all the options available, run `oxen df --help`.
