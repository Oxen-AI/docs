...
Oxen.ai's infrastructure allows you to run these scripts in the cloud on customizable hardware. Here is an example command that kicks off model training on an A10G GPU with 8 cpu cores and 8GB of RAM.
