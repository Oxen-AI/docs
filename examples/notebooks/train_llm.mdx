...
Make sure to configure your notebook with an A10G GPU and the following dependencies. Allocate at least 3 hours, 8 cpu cores and 8GB of memory for the training to complete in a reasonable amount of time.
