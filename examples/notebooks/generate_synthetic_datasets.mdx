...
Follow along with the [example notebook](https://www.oxen.ai/datasets/MarimoNotebooks/file/main/generate_synthetic_datasets.py) by running it in your own Oxen.ai account.
...
Once the data is uploaded, you can view and query the generated dataset from Oxen.ai's [Dataset UI](/features/exploring_data).

![Dataset Interface](/images/marimo/synthetic-data/df-ui.png)

## Running an LLM

If you want to try out different prompts and models without writing any code, you can use Oxen.ai's [Model Inference](/features/models) feature. Click the 🚀 button on the right of the screen to open the inference UI.
