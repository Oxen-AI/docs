...
description: 'How to train a small language model to classify text.'
---

Sentiment analysis is an example of a classification task where you can get the high quality results by fine-tuning a much smaller, cheaper, and faster model. In this example, we will take a dataset of [financial news statements](https://www.oxen.ai/mathi/enhanced-financial-phrasebank) and fine-tune Llama 3.2 3B to categorize them as bad, good, or great news.
