...
You will need to select a model that is able to go from "image" to "text" from the dropdown on the left. Then write a prompt that describes what you want in the caption and any formatting you want to apply. 
