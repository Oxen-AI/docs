...
In this example, we are going to fine-tune a video model to generate videos of a specific character. You can fine-tune any of the fine-tunable video models on Oxen the same way, here we use **LTX-2.3 Pro**. We'll use the manager from *Office Space* (great movie, go watch it if you haven't), and we'll see if we can teach the model his voice, posture and cadence.
...
{/* TODO: add /images/fine_tuning/text-to-video/ltx-playground.jpg once captured */}
