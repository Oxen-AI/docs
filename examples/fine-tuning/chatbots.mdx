...
---
<Card href="https://airtable.com/appDW4XBL7qTihmwi/shrPIy6FeLCj1BIgZ">
...
For this example, we are using a formatted version of the [mlabonne/FineTome-100k](https://www.oxen.ai/mathi/mlabonne-FineTome-100k) dataset from Hugging Face filtered to only educatinal content and limited to the first 3,000 rows.
