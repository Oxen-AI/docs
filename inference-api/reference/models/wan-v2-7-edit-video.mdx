...
description: "Prompt-based video editing"
---
...
|-------|------|---------|-------------|
| `input_video` | `string` | &mdash; | URL of the input video to edit. Format: MP4, MOV. Duration: 2-10s. Max 100 MB. Format: uri. |
| `prompt` | `string` | &mdash; | Editing instruction or style transfer description. |
...
| `duration` | `integer` | `0` | Duration Range: 2 – 10. |
