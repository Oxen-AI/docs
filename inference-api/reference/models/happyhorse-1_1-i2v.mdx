...
HappyHorse 1.1 image-to-video animates a source image into video using a text prompt at 720P or 1080P with durations from 3 to 15 seconds and configurable aspect ratio. It maintains strict consistency with the source image, producing high-quality video that is fluid, natural, and rich in detail.
