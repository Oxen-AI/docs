...
| `prompt` | `string` | &mdash; | Edit instructions. Reference @Image1, @Image2 for reference images and @Element1, @Element2 for elements. |

### Optional parameters

| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `input_image` | `array<string>` | &mdash; | Optional reference images. Use @Image1, @Image2, etc. in the prompt to refer to them. |
| `elements` | `array<object>` | &mdash; | Optional element references. Use @Element1, @Element2, etc. in the prompt to refer to them. |
| `keep_audio` | `boolean` | `true` | Keep the original audio from the source video. |
