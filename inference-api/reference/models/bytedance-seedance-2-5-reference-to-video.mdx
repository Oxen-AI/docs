...
| `resolution` | `string` | `"720p"` | Video resolution. 480p for faster generation, 720p for balance, 1080p for high quality with 10-bit color (H.265/HEVC output). One of: 480p, 720p, 1080p. |
