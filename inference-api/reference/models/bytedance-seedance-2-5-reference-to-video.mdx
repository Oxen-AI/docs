...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `input_face_images` | `array<string>` | &mdash; | Place reference images here when they show faces, people, or characters. Content filters may block the request otherwise. |
...
| `input_face_videos` | `array<string>` | &mdash; | Place reference videos here when they show faces, people, or characters. Content filters may block the request otherwise. |
...
| `aspect_ratio` | `string` | `"adaptive"` | Aspect Ratio One of: adaptive, 21:9, 16:9, 4:3, 1:1, 3:4, 9:16. |
| `duration` | `['integer', 'string']` | `"auto"` | Duration Range: 4 – 30. |
| `resolution` | `string` | `"720p"` | Resolution One of: 480p, 720p, 1080p. |
