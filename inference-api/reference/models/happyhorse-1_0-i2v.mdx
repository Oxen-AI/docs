...
HappyHorse 1.0 image-to-video animates a reference image into video using a text prompt at 720P or 1080P with durations from 3 to 15 seconds. Output aspect ratio follows the source image.
