...
description: "FLUX.2 Klein 4B is a compact 4 billion parameter text-to-image diffusion model optimized for fast inference and high-quality image generation."
---

<CardGroup cols={1}>
  <Card title="Try FLUX.2 Klein 4B in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=black-forest-labs-flux-2-klein-4b">
...
<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=black-forest-labs-flux-2-klein-4b) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
