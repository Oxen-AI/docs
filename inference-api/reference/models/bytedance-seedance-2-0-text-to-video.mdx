...
description: "Text-to-video with flexible duration and aspect ratio, resolution up to 1080p, and optional synchronized audio."
---
...
ByteDance Seedance 2.0 (Pro) generates video from a text prompt. Supports 480p, 720p, and 1080p output, durations from 4-15 seconds, multiple aspect ratios, and optional synchronized audio.
