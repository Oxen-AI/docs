...
LTX 2.3 Extend continues an existing clip, adding 2 to 20 seconds of new footage at its start or end, served directly by Lightricks' LTX API on the Pro tier. The prompt describes what happens in the added portion, and audio is generated for it when the input video has audio.
...
| `duration` | `integer` | `6` | Seconds of new footage to add, 2 to 20. Range: 2 – 20. |
