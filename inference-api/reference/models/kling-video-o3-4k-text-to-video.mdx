...
description: "Native 4K text-to-video generation with cinema-grade detail and optional synchronized audio."
---

<CardGroup cols={1}>
  <Card title="Try Kling O3 4K: Text-to-Video in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=kling-video-o3-4k-text-to-video">
    Run this model interactively, tune parameters, and compare outputs.
  </Card>
</CardGroup>

**Model ID:** `kling-video-o3-4k-text-to-video`
...
<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=kling-video-o3-4k-text-to-video) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
...
```bash
curl -H "Authorization: Bearer $OXEN_API_KEY" https://hub.oxen.ai/api/ai/models/kling-video-o3-4k-text-to-video
```
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text prompt describing the scene to generate. |
