...
Adjust the overall enhancement strength to control how much detail is added, and set the output width to upscale to a larger size (the height scales to match).
...
| `output_width` | `integer` | &mdash; | Target output width in pixels. Height scales to match. Leave unset to keep the original size. One of: 1024, 2048, 4096, 6144. |
