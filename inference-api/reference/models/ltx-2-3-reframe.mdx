...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `aspect_ratio` | `string` | `"9:16"` | Target aspect ratio; the model generates content to fill the revealed areas. One of: 9:16, 16:9, 1:1, 4:5, 5:4. |
| `resolution` | `string` | `"1080p"` | Output resolution tier. 1080p costs more per second. One of: 720p, 1080p. |
