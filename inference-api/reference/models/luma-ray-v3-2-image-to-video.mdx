---
title: "Luma Ray 3.2 - Image to Video"
description: "Image-to-video with prompt control, up to 1080p"
---
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text prompt describing the motion/scene to generate. |
| `input_image` | `string` | &mdash; | URL of the source image the video starts from. Format: uri. |
