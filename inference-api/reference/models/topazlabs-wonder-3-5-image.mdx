---
title: "Topaz Wonder 3.5"
description: "Detail-preserving image enhancement and upscaling"
---

<CardGroup cols={1}>
  <Card title="Try Topaz Wonder 3.5 in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=topazlabs-wonder-3-5-image">
    Run this model interactively, tune parameters, and compare outputs.
  </Card>
</CardGroup>

**Model ID:** `topazlabs-wonder-3-5-image`
...
<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=topazlabs-wonder-3-5-image) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
...
```bash
curl -H "Authorization: Bearer $OXEN_API_KEY" https://hub.oxen.ai/api/ai/models/topazlabs-wonder-3-5-image
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `enhancement_strength` | `string` | `"high"` | Overall enhancement strength. One of: low, medium, high. |
