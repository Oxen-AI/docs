---
title: "LTX 2.3 Pro: Text to Video"
description: "Text-to-video generation up to 4K@50FPS with optional audio and camera motion."
---

<CardGroup cols={1}>
  <Card title="Try LTX 2.3 Pro: Text to Video in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=ltx-2-3-pro-text-to-video">
    Run this model interactively, tune parameters, and compare outputs.
  </Card>
</CardGroup>

**Model ID:** `ltx-2-3-pro-text-to-video`
...
<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=ltx-2-3-pro-text-to-video) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
...
```bash
curl -H "Authorization: Bearer $OXEN_API_KEY" https://hub.oxen.ai/api/ai/models/ltx-2-3-pro-text-to-video
```
