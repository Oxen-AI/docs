...
description: "Compact, fast text-to-image model"
---
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text description of the image to generate. Use @Image1, @Image2, etc. to reference the input images. |
