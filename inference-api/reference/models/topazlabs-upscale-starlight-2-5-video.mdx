...
description: "Detail-preserving video upscaling"
---
...
A detail-preserving upscaler for AI-generated video and archival sources. Use it to upscale input to 1080p or 4k and control output frame rate.
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `resolution` | `string` | `"4k"` | One of: 1080p, 2k, 4k. |
