...
description: "Text-to-video up to 1080p"
---

<CardGroup cols={1}>
  <Card title="Try Happy Horse 1.1 - Text to Video in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=happyhorse-1.1-t2v">
    Run this model interactively, tune parameters, and compare outputs.
  </Card>
</CardGroup>

**Model ID:** `happyhorse-1.1-t2v`

HappyHorse 1.1 text-to-video generates video from a text prompt at 720P or 1080P with durations from 3 to 15 seconds and configurable aspect ratio. It accurately comprehends text semantics to output high-quality video that is fluid, natural, and rich in detail.

## Example request

<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=happyhorse-1.1-t2v) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
...
```bash
curl -H "Authorization: Bearer $OXEN_API_KEY" https://hub.oxen.ai/api/ai/models/happyhorse-1.1-t2v
```
