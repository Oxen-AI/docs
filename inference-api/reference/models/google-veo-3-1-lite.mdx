---
title: "Veo 3.1 Lite"
description: "Cost-efficient text/image-to-video by Google"
---

<CardGroup cols={1}>
  <Card title="Try Veo 3.1 Lite in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=google-veo-3-1-lite">
...
Veo 3.1 Lite is Google's most cost-efficient Veo model, generating high-quality short videos from a text prompt or a first-frame image, with native synchronized audio.

It balances quality and cost for everyday creative and production workflows, with controllable duration, aspect ratio, and resolution.
...
| `resolution` | `string` | `"720p"` | Resolution One of: 720p, 1080p. |
| `duration` | `integer` | `8` | Duration (seconds) Range: 4 – 8. |
