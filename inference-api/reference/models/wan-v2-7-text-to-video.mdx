...
description: "Text-to-video with improved quality, multi-shot generation, up to 1080p, 2-15s duration, and optional audio."
---
...
|-------|------|---------|-------------|
| `prompt` | `string` | `"A kitten running in a meadow, cinematic lighting, smooth camera movement."` | Text prompt describing the desired video. Max 5000 characters. |
...
| `audio_url` | `string` | &mdash; | URL of driving audio. Supports WAV and MP3. Duration: 3-30s. Max 15 MB. If not provided, the model auto-generates matching background music. Format: uri. |
