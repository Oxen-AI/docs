...
description: "Text-to-video, 1080p, multi-shot"
---
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text prompt describing the desired video. Supports Chinese and English. Max 500 characters. Use 'generate a single-shot video' or 'generate a multi-shot video' (or timestamped shot descriptions like 'Shot 1 [0-3s] Wide angle: ...') to control shot structure. |
