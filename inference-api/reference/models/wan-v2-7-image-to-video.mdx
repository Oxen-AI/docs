...
description: "Image-to-video, 1080p, frame control"
---
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text prompt describing the desired video. Supports Chinese and English. Max 5000 characters. |
