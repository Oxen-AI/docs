...
ByteDance Seedance 2.0 (Pro) generates video from a text prompt guided by reference images, videos, and/or audio..
...
| `resolution` | `string` | `"720p"` | Video resolution. One of: 480p, 720p, 1080p, 4k. |
