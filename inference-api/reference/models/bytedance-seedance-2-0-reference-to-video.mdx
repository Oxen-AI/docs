...
description: "Reference-guided video with audio"
---
...
ByteDance Seedance 2.0 (Pro) generates video from a text prompt guided by reference images, videos, and/or audio. Supports 480p, 720p, 1080p, and 4k output.
...
| `resolution` | `string` | `"720p"` | Resolution One of: 480p, 720p, 1080p, 4k. |
