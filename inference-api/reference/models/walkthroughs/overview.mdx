...
<CardGroup cols={2}>
  ...
  <Card title="Seedance 2.5: Draft Mode" icon="clapperboard" href="/inference-api/reference/models/walkthroughs/seedance_2_5_draft_mode">
    Preview a shot at 480p, then render the exact same shot at 1080p with one more request. Works on the sync endpoint and the queue.
  </Card>
