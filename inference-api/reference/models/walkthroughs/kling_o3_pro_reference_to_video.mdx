...
Generation runs in the background and usually takes 1 to 5 minutes. Enqueueing returns a
...
| `num_generations must be an integer between 1 and 12` | Invalid count (via `/ai/queue`) | Use 1-4 |
