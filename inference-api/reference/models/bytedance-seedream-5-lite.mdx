...
description: "Image generation and editing, up to 4K"
---
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text prompt for image generation. Use @Image1, @Image2, etc. to reference the input images. |
...
| `size` | `string` | `"2K"` | Image resolution. One of: 2K, 3K, 4K. |
