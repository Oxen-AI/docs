...
description: "Image generation with multi-reference control (up to 14 images), batch generation, and 3K resolution support."
---
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `input_image` | `string` | &mdash; | Optional URL of a single reference image for image-to-image generation. Format: uri. |
| `input_images` | `array<string>` | &mdash; | Optional list of reference image URLs for multi-reference editing. Up to 14 images. |
