...
Grok Imagine - Image Edit is part of xAI's Grok Imagine suite, a multimodal creative stack supporting image-to-image generation with strong prompt adherence, cinematic aesthetics, style adaptation (including anime), and advanced world/physics understanding. It excels in believable lighting, coherent composition, and production-ready outputs suitable for video game ads and creative workflows. This endpoint specifically handles prompt-guided image editing.
