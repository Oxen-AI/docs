...
description: "Edit images with Grok Imagine"
---

<CardGroup cols={1}>
  <Card title="Try Grok Imagine - Image Edit in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=xai-grok-imagine-image-edit">
...
<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=xai-grok-imagine-image-edit) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
...
| `input_image` | `string` | &mdash; | Image you want to edit. Format: uri. |
