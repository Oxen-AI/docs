...
Grok Imagine text-to-image is part of xAI's Grok Imagine suite, a multimodal creative stack supporting text-to-image generation with strong prompt adherence, cinematic aesthetics, style adaptation (including anime), and advanced world/physics understanding. It excels in believable lighting, coherent composition, and production-ready outputs suitable for video game ads and creative workflows.
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `aspect_ratio` | `string` | `"16:9"` | Aspect Ratio One of: 1:1, 16:9, 9:16, 4:3, 3:4, 3:2, 2:3, 2:1, 20:9, 19.5:9, 9:19.5, 9:20, 1:2. |
| `resolution` | `string` | `"2k"` | Resolution One of: 1k, 2k. |
| `output_format` | `string` | `"webp"` | Format of the output images One of: webp, jpeg, png. |
