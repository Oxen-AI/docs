...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `aspect_ratio` | `string` | `"16:9"` | Aspect ratio for the generated image One of: 1:1, 16:9, 9:16, 4:3, 3:4, 3:2, 2:3, 2:1, 20:9, 19.5:9, 9:19.5, 9:20, 1:2. |
| `resolution` | `string` | `"2k"` | Resolution of the generated image One of: 1k, 2k. |
