...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `input_image` | `string` | &mdash; | Optional first-frame image to animate (image-to-video). Leave empty to generate from the prompt alone. Must be jpeg, png, gif, or webp. Format: uri. |
| `aspect_ratio` | `string` | `"16:9"` | Video aspect ratio One of: 16:9, 9:16. |
| `resolution` | `string` | `"1080p"` | Resolution of the generated video. 1080p and 4k require an 8 second duration. One of: 720p, 1080p, 4k. |
