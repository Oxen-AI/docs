...
LTX 2.5 generates video from a text prompt, a first-frame image, or an audio track, served directly by Lightricks' LTX API. A single model covers all three modes.
