---
title: "Seedream 4.0"
description: "Photorealistic 4K image generation"
---
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text prompt for image generation. Recommended length &lt;=600 English words. Use @Image1, @Image2, etc. to reference the input images. |

### Optional parameters

| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `input_image` | `array<string>` | &mdash; | Optional reference image URLs for image-to-image editing. Provide one image for single-image editing or multiple for multi-reference fusion; reference them in the prompt as @Image1, @Image2, etc. Up to 14 images. |
