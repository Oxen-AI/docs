---
title: "Seedream 4.0"
description: "Image generation with single- and multi-reference editing and resolutions from 1K to 4K."
---
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text prompt for image generation. Recommended length &le;600 English words. |
