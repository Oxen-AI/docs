...
description: "Cinematic text-to-video with native audio"
---
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `negative_prompt` | `string` | &mdash; | Text description of what you *do not* want the model to do. |
| `generate_audio` | `boolean` | `true` | Generate audio with the video. |
| `aspect_ratio` | `string` | `"16:9"` | Aspect Ratio One of: 9:16, 16:9, 1:1. |
