...
description: "Studio-quality 4K image generation"
---
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `input_image` | `array<string>` | &mdash; | Optional reference image(s) to edit or compose (up to 14). Leave empty to generate from the prompt alone. Reference them in the prompt as @Image1, @Image2, etc. |
| `aspect_ratio` | `string` | `"16:9"` | Aspect Ratio One of: auto, 1:1, 16:9, 9:16, 4:3, 3:4, 3:2, 2:3, 4:5, 5:4, 21:9. |
