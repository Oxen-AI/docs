...
| Multilingual       | No (English text prompts) |
...
| `prompt` | `string` | &mdash; | Text description of what you want to segment out of the image. |
...
| `output_format` | `string` | `"png"` | Format of the output images One of: jpeg, png. |
