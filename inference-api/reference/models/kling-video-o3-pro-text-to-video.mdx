...
description: "Pro 1080p cinematic text-to-video"
---

<CardGroup cols={1}>
  <Card title="Try Kling O3 Pro: Text-to-Video in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=kling-video-o3-pro-text-to-video">
    Run this model interactively, tune parameters, and compare outputs.
  </Card>
</CardGroup>

**Model ID:** `kling-video-o3-pro-text-to-video`

Kling O3 Pro text-to-video generates 1080p cinematic clips from a prompt, with optional native audio, multi-shot storyboarding, and durations from 3 to 15 seconds.

## Example request

<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=kling-video-o3-pro-text-to-video) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
    ...
    <Tabs>
      <Tab title="Minimal">
        ...
        curl -X POST https://hub.oxen.ai/api/ai/videos/generate \
          ...
          -d '{
          "model": "kling-video-o3-pro-text-to-video"
        }'
        ```
...
```bash
curl -H "Authorization: Bearer $OXEN_API_KEY" https://hub.oxen.ai/api/ai/models/kling-video-o3-pro-text-to-video
```
...
| `generate_audio` | `boolean` | `false` | Generate native synchronized audio (English or Chinese). |
