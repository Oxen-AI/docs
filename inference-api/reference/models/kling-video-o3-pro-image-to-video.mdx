...
description: "Kling Video O3 Pro is an advanced image-to-video generation model that animates static images into high-quality videos based on text prompts."
---

<CardGroup cols={1}>
  <Card title="Try Kling O3 Pro: Image-to-Video in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=kling-video-o3-pro-image-to-video">
    Run this model interactively, tune parameters, and compare outputs.
  </Card>
</CardGroup>

**Model ID:** `kling-video-o3-pro-image-to-video`
...
<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=kling-video-o3-pro-image-to-video) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text prompt describing the motion or action for the video |
| `input_image` | `string` | &mdash; | Start frame to generate the video from. Format: uri. |

### Optional parameters

| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `tail_image_url` | `string` | &mdash; | Frame to end the generation on. Format: uri. |
