...
description: "Image-to-video with audio by xAI"
---
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `aspect_ratio` | `string` | `"16:9"` | Aspect Ratio One of: auto, 1:1, 16:9, 9:16, 4:3, 3:4, 3:2, 2:3. |
| `duration` | `integer` | `6` | Duration Range: 3 – 15. |
| `resolution` | `string` | `"480p"` | Resolution One of: 720p, 480p. |
