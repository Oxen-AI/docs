---
title: "Topaz Iris - Face Detail Video Upscaler"
description: "Face-focused video upscaling"
---

<CardGroup cols={1}>
  <Card title="Try Topaz Iris - Face Detail Video Upscaler in the Workbench" icon="flask" href="https://www.oxen.ai/ai/workbench?model=topazlabs-iris-mq-video">
    Run this model interactively, tune parameters, and compare outputs.
  </Card>
</CardGroup>

**Model ID:** `topazlabs-iris-mq-video`
...
<Tip>
  Use the [Workbench](https://www.oxen.ai/ai/workbench?model=topazlabs-iris-mq-video) as a request builder: configure parameters for this model in the UI, then open the **API** tab to copy the exact cURL or Python call.
</Tip>
...
```bash
curl -H "Authorization: Bearer $OXEN_API_KEY" https://hub.oxen.ai/api/ai/models/topazlabs-iris-mq-video
```
