...
LTX 2.3 Retake regenerates a section of an existing clip guided by a prompt — change a line of dialogue, an action, or the sound without touching the rest — served directly by Lightricks' LTX API on the Pro tier. It can replace the section's video, its audio, or both.
