...
description: "Pro video-to-video editing"
---
...
| `input_video` | `string` | &mdash; | Source video to edit. MP4/MOV, 3-15s, 720-3840px, max 200MB. Output duration matches input. Format: uri. |
