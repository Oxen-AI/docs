...
Some other noteworthy features of Claude Sonnet 4.6 include adaptive thinking, extended thinking support, and a 1M token context window in beta for long-context reasoning workloads.
