...
description: "In-context image editing model"
---
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `aspect_ratio` | `string` | `"16:9"` | Aspect ratio of the generated image. Use 'match_input_image' to match the aspect ratio of the input image. One of: 1:1, 16:9, 21:9, 3:2, 2:3, 4:5, 5:4, 3:4, 4:3, 9:16, 9:21, match_input_image. |
