...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `resolution` | `string` | `"auto"` | Output image resolution. HD sizes (1920x1080 and lower) bill at the standard tier; QHD+ sizes (2560x1440 and higher) bill at the high-resolution tier. One of: auto, 1024x768, 1024x1024, 1024x1536, 1920x1080, 2560x1440, 3840x2160. |
| `quality` | `string` | `"high"` | Output quality tier. Use 'auto' to let the model pick, or set explicitly to low, medium, or high. One of: auto, low, medium, high. |
