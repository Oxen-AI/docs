...
description: "Text-and-image to image generation"
---
...
| `aspect_ratio` | `string` | `"16:9"` | Aspect Ratio One of: 1:1, 16:9, 9:16, 4:3, 3:4, 3:2, 2:3, 2:1, 1:2. |
| `enable_prompt_expansion` | `boolean` | `true` | Automatically expand and optimize the prompt for better results |
| `negative_prompt` | `string` | &mdash; | Negative prompt to specify elements to avoid in the generated image |
