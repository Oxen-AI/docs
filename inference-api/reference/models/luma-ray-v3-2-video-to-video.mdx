...
| `prompt` | `string` | &mdash; | Text prompt describing how to edit the source video. |
...
| `resolution` | `string` | `"540p"` | Resolution One of: 540p, 720p, 1080p. |
| `duration` | `string` | `"5s"` | Duration One of: 5s, 10s. |
