...
|-------|------|---------|-------------|
| `prompt` | `string` | &mdash; | Text description of the video to generate. Use @Video1, @Video2, etc. to reference the input videos. |

### Optional parameters

| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `input_videos` | `array<string>` | &mdash; | Reference videos that guide the generated video. Reference them in the prompt as @Video1, @Video2, etc. |
