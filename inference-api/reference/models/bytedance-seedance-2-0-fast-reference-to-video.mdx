...
ByteDance Seedance 2.0 Fast generates video from a text prompt guided by reference images, videos, and audio. Reference media are addressed in the prompt as @Image1, @Video1, @Audio1 (1-based positional index within each media type).
