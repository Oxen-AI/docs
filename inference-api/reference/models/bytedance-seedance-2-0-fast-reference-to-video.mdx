...
description: "Fast reference-guided video generation"
---
...
ByteDance Seedance 2.0 Fast generates video from a text prompt guided by reference images, videos, and audio. Supports 480p and 720p output.
