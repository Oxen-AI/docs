...
description: "Faster, lower-cost reference-guided video from prompt plus optional images, videos, and audio references."
---
...
ByteDance Seedance 2.0 Fast generates video from a text prompt guided by reference images, videos, and audio. Reference media are addressed in the prompt as [Image 1], [Video 1], [Audio 1] (1-based positional index within each media type).
