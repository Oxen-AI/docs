...
- [Claude Fable 5.1](/inference-api/reference/models/claude-fable-5-1)
...
- [FLUX Video Edit](/inference-api/reference/models/flux-video-edit)
...
- [DeepSeek V4.1 Flash](/inference-api/reference/models/deepseek-v4-1-flash)
...
- [Gemini 3.7 Flash](/inference-api/reference/models/gemini-3-7-flash)
- [Gemini 3.8 Flash](/inference-api/reference/models/gemini-3-8-flash)
- [Gemini 3 Flash](/inference-api/reference/models/gemini-3-flash-preview)
- [Gemini Omni 1.1 Flash](/inference-api/reference/models/gemini-omni-1-1-flash)
...
- [Muse Image 1.0](/inference-api/reference/models/muse-image-1-0)
- [Muse Spark 1.3](/inference-api/reference/models/muse-spark-1-3)
...
- [MiniMax H3 Max: Image to Video](/inference-api/reference/models/minimax-h3-max-image-to-video)
- [MiniMax H3 Max: Reference to Video](/inference-api/reference/models/minimax-h3-max-reference-to-video)
- [MiniMax H3 Max: Text to Video](/inference-api/reference/models/minimax-h3-max-text-to-video)
...
- [GPT 6 Astra](/inference-api/reference/models/gpt-6-astra)
...
- [GPT Image 2.5 Flare](/inference-api/reference/models/gpt-image-2-5-flare)
- [GPT Image 2.5 Sunburst](/inference-api/reference/models/gpt-image-2-5-sunburst)
...
- [Qwen3.8 Omni Flash](/inference-api/reference/models/qwen3-8-omni-flash)
...
- [GLM 5.3 Flash](/inference-api/reference/models/glm-5-3-flash)
