...
| `draft` | boolean | no | `false` | Render a 480p draft that can later be re-rendered at 1080p. Seedance 2.5 only. See [Seedance 2.5: Draft Mode](/inference-api/reference/models/walkthroughs/seedance_2_5_draft_mode). |
| `draft_task_id` | string | no | -- | Render the 1080p final of a previous draft. Replaces `prompt`. Seedance 2.5 only. |
...
- Seedance 2.5 supports [draft mode](/inference-api/reference/models/walkthroughs/seedance_2_5_draft_mode): preview at 480p, then re-render the same shot at 1080p.
