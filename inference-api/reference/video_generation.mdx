...
| `multi_prompt` | array | **one of** | -- | Multi-shot prompts with per-shot duration. See [Kling O3 Pro reference](/inference-api/reference/kling_o3_pro_reference_to_video) for details. |
