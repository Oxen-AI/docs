...
Open the dataset you want to work with. You can find an example dataset on our [explore page](https://www.oxen.ai/explore) or if you want to follow along with the example, you can clone the [Amazon Product Sample](https://www.oxen.ai/mathias/amazon-product-sample/file/main/sample.csv) dataset we are using.
...
You will now find Oxen's model evaluation feature. Here, select your model, give your evaluation a name, fill in your prompt with the values you want to pass to the model. For this example, we will use [Mistral-7B](https://mistral.ai/technology/#models) and the following prompt:
...
If you would like some effective tips for prompting, we just posted a [blog](https://www.oxen.ai/blog/the-prompt-report-part-1-a-systematic-survey-of-prompting-techniques) on cutting-edge prompting techniques.
