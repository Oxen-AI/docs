...
This tutorial will show you how to create embeddings to use for RAG using the [Simple Wikipedia Dataset](https://www.oxen.ai/ox/Simple-Wikipedia-50k), for the second step in a RAG pipeline, check out [🧠 RAG Extracting Answers](/use-cases/rag-extracting-answers).
...
<img
  className="block"
  src="/images/synthetic-data-eval.png"
  alt="Eval for synthetic Data"
/>
