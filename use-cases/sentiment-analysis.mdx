...
Open the dataset you want to work with. You find an example dataset on our [explore page](https://www.oxen.ai/explore) or if you want to follow along with the example, you can clone the [financial sentiment dataset](https://www.oxen.ai/ox/financial_sentiment) we are using.
