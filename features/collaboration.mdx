---
title: '🤝 Collaboration'
description: 'OxenHub enables your team to version, branch, and share datasets with your team.'
---

The Oxen Hub is a simple web interface that allows you to discover and explore datasets without having to download them. You can also upload files directly, add permissions, and explore branches directly in the interface.

The Oxen Hub also provides a wide arrange of data exploration tools including:

* 🔎 [Explore Data](/features/exploring_data): Query your data in Natural Language with Text to SQL generation.

* 🏷️ [Labeling Data](/features/labeling_data): Edit any of your datasets straight from our UI.

* 📝 [Notebooks](/features/notebooks): Write code in Python Notebooks and commit them to your repository.

* 🚀 [Model Inference](/features/models): Run models on your data simply by writing a prompt.

![Oxen Image Net Files](/images/ImageNet-Oxen-DataFrame.png)
