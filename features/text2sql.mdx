...
Open the dataset you want to work with. You can find an example dataset on our [explore page](https://www.oxen.ai/explore) or if you want to follow along with the example, you can clone the [Thinking LLMs dataset](https://www.oxen.ai/ox/Thinking-LLMs).
...
<img alt="Text 2 SQL prompt example" classname="block" src="/images/count_dist.png" />
