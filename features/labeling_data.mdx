...
## Committing Changes or Returning to Dataframe
...
To delete uncommitted changes, click the *Workspaces* Tab on the top of your editing space and delete the workspace you were using with the changes.
...
Congratulations! You've just seen how easy it is to edit your datasets without downloading on Oxen.AI. For more examples of different uses, [click here](/use-cases/sentiment-analysis.mdx)!