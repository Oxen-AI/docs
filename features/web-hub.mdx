...
The Oxen Hub also provides a wide arrange of data exploration tools including one click [Model Inference](/oxen-hub/rmod.mdx), [UI Editable Dataframes](/oxen-hub/editable-dfs.mdx), and [Text2SQL search](/oxen-hub/text2sql.mdx).


<p align="center">
<<<<<<<< HEAD:oxen-hub/oxen-hub.mdx
    <img src="/images/example_repo.png?raw=true"
    alt="Pixart Example Repo" />
========
    <img src="/images/ImageNet-Oxen-Files.png?raw=true" alt="oxen ImageNet files" />
>>>>>>>> main:features/web-hub.mdx
</p>
...
🎉 Congrats! Now your have your team and data in the hub and are ready to start building out your data pipeline with Oxen's one click [Model Inference](/oxen-hub/rmod.mdx), [UI Editable Dataframes](/oxen-hub/editable-dfs.mdx), and [Text2SQL search](/oxen-hub/text2sql.mdx).
