...
| Tool            | Time                |
|-----------------|---------------------|
| __🐂 Oxen.ai__   | 1 hour and 30 mins |
...
With Oxen.ai, we take a different approach. Rather than trying to extend Git, we built Oxen, a new tool designed specifically to make versioning large amounts of data as fast as possible. Under the hood, Oxen uses Merkle trees, smart network protocols and fast hashing algorithms to reduce the amount of data our repositories store. 
